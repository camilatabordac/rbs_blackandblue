...
export function SpecialistsSection() {
  ...
  return (
    <section id="especialistas" className="py-16 bg-gray-900" ref={sectionRef}>
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-white mb-4">Conheça Nossa Equipe</h2>
          ...
          {specialists.map((specialist, index) => (
            ...
            >
              ...
              <div className="p-6 text-center">
                <h3 className="text-xl font-bold text-black mb-1">{specialist.name}</h3>
                <p className="text-[#55bbad] font-medium mb-3">{specialist.specialty}</p>
                <p className="text-gray-900 text-sm">{specialist.bio}</p>
              </div>
            </div>
          ))}
        </div>
