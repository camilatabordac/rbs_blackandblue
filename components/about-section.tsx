...
export function AboutSection() {
  ...
  return (
    <section id="quem-somos" className="py-16 bg-gray-900" ref={sectionRef}>
      <div className="container">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl font-bold text-white">Quem Somos</h2>
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4">
              <a href={siteConfig.contact.whatsappLink} target="_blank" rel="noopener noreferrer">
                <Button className="bg-white hover:bg-[#cce3e0] font-bold text-[#489e92]">Conheça Nossa História</Button>
              </a>
            </div>
          </div>
        </div>
