...
export function LocationSection() {
  ...
  return (
    <section id="localizacao" className="py-16 bg-gray-900" ref={sectionRef}>
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-white mb-4">Localização e Horário</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div
            className={`bg-gray-900 rounded-xl overflow-hidden transition-all duration-1000 ${
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex justify-between">
                      ...
                      <p className="text-gray-300">{siteConfig.hours.saturday}</p>
                    </div>
                  </div>
                </div>
              </div>
