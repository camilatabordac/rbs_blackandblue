      ...
      <div className="container">
        ...
        >
          <div className="relative">
            ...
            {/* Setas de navegação */}
            <button
              className="absolute top-1/2 left-0 -translate-y-1/2 -translate-x-1 bg-white rounded-full p-2 shadow-md hover:bg-gray-700 transition-colors z-10"
            ...
            <button
              className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1 bg-white rounded-full p-2 shadow-md hover:bg-gray-700 transition-colors z-10"
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`h-3 w-3 rounded-full transition-colors ${
                    activeIndex === index ? "bg-[#55bbad]" : "bg-white"
                  }`}
