    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-8">
          <Link href="#quem-somos" className="text-sm font-bold text-gray-700 hover:text-[#55bbad] transition-colors">
            Quem Somos
          </Link>
          <Link href="#servicos" className="text-sm font-bold text-gray-700 hover:text-[#55bbad] transition-colors">
            Serviços
          </Link>
          <Link
            href="#especialistas"
            className="text-sm font-bold text-gray-700 hover:text-[#55bbad] transition-colors"
          >
            Especialistas
          </Link>
          <Link href="#depoimentos" className="text-sm font-bold text-gray-700 hover:text-[#55bbad] transition-colors">
            Depoimentos
          </Link>
          <Link href="#localizacao" className="text-sm font-bold text-gray-700 hover:text-[#55bbad] transition-colors">
            Localização
          </Link>
        </nav>
